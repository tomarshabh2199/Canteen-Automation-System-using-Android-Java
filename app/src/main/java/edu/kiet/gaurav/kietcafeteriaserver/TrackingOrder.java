...
import edu.kiet.gaurav.kietcafeteriaserver.Common.DirectionJSONParser;
    ...
    private void displayLocation() {
                ...
                && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION)!= PackageManager.PERMISSION_GRANTED)
        {
            ...
            if(mLastLocation!= null)
            {
                ...
                mMap.addMarker(new MarkerOptions().position(yourLocation).title("YourLocation"));
            ...
            else
            {
                ...
                Log.d("DEBUG","Could'nt get the location");
            }
        }
